...
public class ChatUserPairModel {
    ...
    public ChatUserPairModel(Map<String, Long> chat_position, ArrayList<String> user_ids, String last_message, String last_message_sender_id, String last_message_receiver_id, Timestamp last_message_timestamp) {
